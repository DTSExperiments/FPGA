...
#
# Script generated by Vivado on Tue Sep 03 09:52:03 +0200 2024
...
# script info
echo -e "xadc_wiz_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/FPGA_Gray/flySimulator.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
