...
OPTRACE "add files" START { }
  add_files -quiet D:/flySimulator/flySimulator.runs/synth_1/flySimulator.dcp
...
OPTRACE "link_design" START { }
  link_design -top flySimulator -part xc7a200tsbg484-1
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force flySimulator_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file flySimulator_drc_opted.rpt -pb flySimulator_drc_opted.pb -rpx flySimulator_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force flySimulator_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file flySimulator_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file flySimulator_utilization_placed.rpt -pb flySimulator_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file flySimulator_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force flySimulator_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force flySimulator_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file flySimulator_drc_routed.rpt -pb flySimulator_drc_routed.pb -rpx flySimulator_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file flySimulator_methodology_drc_routed.rpt -pb flySimulator_methodology_drc_routed.pb -rpx flySimulator_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file flySimulator_power_routed.rpt -pb flySimulator_power_summary_routed.pb -rpx flySimulator_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file flySimulator_route_status.rpt -pb flySimulator_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file flySimulator_timing_summary_routed.rpt -pb flySimulator_timing_summary_routed.pb -rpx flySimulator_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file flySimulator_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file flySimulator_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file flySimulator_bus_skew_routed.rpt -pb flySimulator_bus_skew_routed.pb -rpx flySimulator_bus_skew_routed.rpx"
...
if {$rc} {
  write_checkpoint -force flySimulator_routed_error.dcp
